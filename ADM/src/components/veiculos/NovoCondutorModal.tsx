...
interface NovoCondutorModalProps {
  open: boolean
  onOpenChange: (open: boolean) => void
}

export function NovoCondutorModal({ open, onOpenChange }: NovoCondutorModalProps) {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      const novoCondutor = {
        ...
        ...values,
        pontuacaoAtual: 0, // Pontuação inicial
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Novo Condutor & CNH</DialogTitle>
        </DialogHeader>
