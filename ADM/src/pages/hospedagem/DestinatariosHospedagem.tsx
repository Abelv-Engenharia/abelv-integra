...
export default function DestinatariosHospedagem() {
    ...
    <div className="min-h-screen p-8 animate-in fade-in-0 duration-500">
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Configuração de Destinatários - Hospedagem</h1>
            <p className="text-muted-foreground">Cadastro de responsáveis por obra para recebimento de alertas de hospedagem</p>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Lista de destinatários para alertas gerais do sistema de hospedagem
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Cadastro de responsáveis por obra para recebimento de alertas de hospedagem
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex justify-end">
              <Dialog open={openDestinatarioDialog} onOpenChange={setOpenDestinatarioDialog}>
                ...
                <DialogContent className="max-w-md">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Cadastre um novo responsável por obra para recebimento de alertas de hospedagem
                    </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4 py-4">
                    <div className="space-y-2">
