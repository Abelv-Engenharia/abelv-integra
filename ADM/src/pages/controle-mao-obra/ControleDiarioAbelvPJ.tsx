...
export default function ControleDiarioAbelvPJ() {
  const { toast } = useToast();
  const { colaboradores: colaboradoresEfetivo } = useColaboradoresAbelvPJ();
  ...
  const handleExportar = () => {
    toast({
      title: "Exportando",
      description: "Relatório de efetivo diário abelv + pj sendo gerado..."
    });
  };
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold tracking-tight">Controle de efetivo diário - abelv + pj</h1>
              <p className="text-muted-foreground">Registro diário de presença dos colaboradores abelv + pj</p>
            </div>
