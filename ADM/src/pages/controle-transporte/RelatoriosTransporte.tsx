...
export default function RelatoriosTransporte() {
            ...
            <TableBody>
              {mockDados.medicoes.map((medicao) => (
                <TableRow key={medicao.id}>
                  ...
                  <TableCell>{medicao.tipo_transporte}</TableCell>
                  <TableCell>{medicao.viagens}</TableCell>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Realizado Viagens</TableHead>
            ...
            <TableBody>
              {mockDados.metas.map((meta) => (
                <TableRow key={meta.id}>
                  ...
                  <TableCell>{meta.meta_viagens}</TableCell>
                  <TableCell>R$ {meta.meta_valor.toFixed(2)}</TableCell>
                  <TableCell>{meta.realizado_viagens}</TableCell>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div className="space-y-2">
              <Select value={filtros.tipo_transporte} onValueChange={(value) => setFiltros({...filtros, tipo_transporte: value})}>
                <SelectTrigger>
        ...
        <TabsContent value="parametros" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configuração de alertas automáticos para o módulo de transporte
              </CardDescription>
            </CardHeader>
            <CardContent>
