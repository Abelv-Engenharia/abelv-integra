...
const mockAlertas = [
  {
    ...
    descricao: "Falha na integração da NF ALI-001234 - Erro de conexão com API",
    data_identificacao: "2024-09-25",
    responsavel: "Matricial",
    vinculo_medicao: "ALIM-001",
    vinculo_nf: "NF-ALI-001234",
    status: "aberto",
  ...
  },
  {
    ...
    obra: "Obra Guarulhos",
    tipo: "Documental",
    descricao: "NF de alimentação lançada sem vínculo de Medição - NF ALI-001235",
    data_identificacao: "2024-09-24",
    responsavel: "Administrativo",
    vinculo_medicao: "",
    vinculo_nf: "NF-ALI-001235",
    status: "em_tratativa",
  ...
  },
  {
    ...
    obra: "Obra São Paulo Centro", 
    tipo: "Operacional",
    descricao: "Medição de Alimentação Validada sem NF há 7 dias - ALIM-002",
    data_identificacao: "2024-09-20",
    responsavel: "Matricial",
    vinculo_medicao: "ALIM-002",
    vinculo_nf: "",
    status: "resolvido",
  ...
  },
  {
    ...
    obra: "Obra Osasco",
    tipo: "Financeiro",
    descricao: "Meta mensal não atingida - apenas 45% do efetivo alimentado em setembro",
    data_identificacao: "2024-10-01",
    responsavel: "Administrativo",
    vinculo_medicao: "",
    vinculo_nf: "",
    status: "aberto",
    observacoes: "Necessário justificativa"
  }
];

export default function AlertasAlimentacao() {
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Monitorar pendências, inconsistências e falhas de integração da alimentação</p>
        </div>
      </div>
