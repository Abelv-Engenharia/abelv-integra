...
export function ColaboradoresProvider({ children }: { children: ReactNode }) {
  ...
  // Buscar colaboradores do tipo 'terceiro' do Supabase
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel('colaboradores_efetivo_terceiro_changes')
      .on(
        'postgres_changes',
        {
          event: '*',
          ...
          filter: 'tipo_colaborador=eq.terceiro'
        },
        () => {
          carregarColaboradores();
        }
...
export function useColaboradores() {
  ...
  if (context === undefined) {
    throw new Error('useColaboradores deve ser usado dentro de ColaboradoresProvider');
  }
  return context;
}
