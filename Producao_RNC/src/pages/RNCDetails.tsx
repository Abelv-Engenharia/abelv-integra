...
import { ArrowLeft, Edit, Calendar, User, Building, AlertTriangle, CheckCircle, FileText, Image, Download, Eye } from "lucide-react";
        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-soft">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm">Cliente / Fiscalização</span>
