...
CREATE INDEX idx_relatorios_mecanica_data ON public.relatorios_mecanica(data);
CREATE INDEX idx_relatorios_mecanica_cca ON public.relatorios_mecanica(cca_id);
CREATE INDEX idx_relatorios_mecanica_localizacao ON public.relatorios_mecanica(localizacao_id);
CREATE INDEX idx_atividades_principais_relatorio ON public.atividades_principais(relatorio_id);
CREATE INDEX idx_relatorios_atividades_principal ON public.relatorios_atividades(atividade_principal_id);
CREATE INDEX idx_status_juntas_atividade ON public.status_juntas(relatorio_atividade_id);
