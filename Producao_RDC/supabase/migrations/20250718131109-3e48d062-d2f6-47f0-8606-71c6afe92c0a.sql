...
CREATE TABLE public.Base_tubulacao (
  id bigint NOT NULL DEFAULT nextval('base_tubulacao_id_seq'::regclass) PRIMARY KEY,
...
-- Criar sequência para o ID (caso não exista)
CREATE SEQUENCE IF NOT EXISTS base_tubulacao_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
