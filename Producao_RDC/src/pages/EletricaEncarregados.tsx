...
export default function EletricaEncarregados() {
  const [encarregados, setEncarregados] = useState<EncarregadoEletrica[]>([]);
  const [ccas, setCcas] = useState<CCA[]>([]);
  const [isDialogOpen, setIsDialogOpen] = useState(false);
  const [editingEncarregado, setEditingEncarregado] = useState<EncarregadoEletrica | null>(null);
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    ativo: true,
    equipe: [] as FuncaoEquipeEletrica[],
    cca_id: ""
  });
  ...
  const carregarEncarregados = async () => {
    try {
      ...
      // Converter Json para FuncaoEquipeEletrica[] e garantir tipo correto
  ...
  const handleEdit = (encarregado: EncarregadoEletrica) => {
      ...
      <div className="container mx-auto p-6 space-y-6">
        <Card className="border-l-4 border-l-blue-500 border-blue-200 dark:border-blue-800">
          <CardHeader className="bg-blue-50 dark:bg-blue-950/20">
            <CardTitle className="text-blue-800 dark:text-blue-200">Cadastro de Encarregados - Elétrica/Instrumentação</CardTitle>
            <CardDescription className="text-blue-600 dark:text-blue-300">
              Gerencie os encarregados responsáveis pelos relatórios de elétrica e instrumentação
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      {editingEncarregado ? "Editar informações do encarregado" : "Cadastrar novo encarregado de elétrica"}
                    </DialogDescription>
                  </DialogHeader>
                      ...
                      <div className="grid grid-cols-4 items-start gap-4">
                        ...
                        <div className="col-span-3">
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            Defina funções e quantidades da equipe de elétrica deste encarregado.
                          </p>
                        </div>
                      </div>
                      <div className="grid grid-cols-4 items-center gap-4">
