...
interface AtividadeCadastradaEletrica {
  id: string
  nome: string
...
export default function EletricaAtividades() {
  const [nome, setNome] = useState("")
  const [descricao, setDescricao] = useState("")
  const [atividades, setAtividades] = useState<AtividadeCadastradaEletrica[]>([])
  ...
  const adicionarAtividade = async () => {
    ...
    try {
      ...
      toast({
        title: "Sucesso",
        description: "Atividade de elétrica adicionada com sucesso!"
      })
  ...
  return (
    <Layout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-primary">Cadastro de Atividades - Elétrica/Instrumentação</h1>
          <p className="text-muted-foreground">
            Gerencie as atividades disponíveis para os registros de elétrica e instrumentação.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card className="border-l-4 border-l-blue-500 border-blue-200 dark:border-blue-800">
            <CardHeader className="bg-blue-50 dark:bg-blue-950/20">
              <CardTitle className="text-xl text-blue-800 dark:text-blue-200">Nova Atividade Elétrica</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="Ex: Instalação Elétrica, Montagem de Painel..."
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Descrição detalhada da atividade elétrica (opcional)"
                  className="mt-1"
                  rows={3}
                />
              </div>
            ...
            <CardContent>
              {atividades.length === 0 ? (
                <p className="text-muted-foreground text-center py-4">
                  Nenhuma atividade de elétrica cadastrada
                </p>
              ) : (
