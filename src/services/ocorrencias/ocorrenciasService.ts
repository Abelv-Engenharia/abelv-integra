...
export const createOcorrencia = async (data: any) => {
  try {
    ...
    const ocorrenciaData = {
      ...
      houve_afastamento: data.colaboradores_acidentados?.[0]?.houve_afastamento || data.houve_afastamento || '',
      dias_perdidos: data.colaboradores_acidentados?.[0]?.dias_perdidos ? Number(data.colaboradores_acidentados[0].dias_perdidos) : (data.dias_perdidos ? Number(data.dias_perdidos) : null),
      dias_debitados: data.colaboradores_acidentados?.[0]?.dias_debitados ? Number(data.colaboradores_acidentados[0].dias_debitados) : (data.dias_debitados ? Number(data.dias_debitados) : null),
      parte_corpo_atingida: data.colaboradores_acidentados?.[0]?.parte_corpo_atingida || data.parte_corpo_atingida || '',
      lateralidade: data.colaboradores_acidentados?.[0]?.lateralidade || data.lateralidade || '',
      agente_causador: data.colaboradores_acidentados?.[0]?.agente_causador || data.agente_causador || '',
      situacao_geradora: data.colaboradores_acidentados?.[0]?.situacao_geradora || data.situacao_geradora || '',
      natureza_lesao: data.colaboradores_acidentados?.[0]?.natureza_lesao || data.natureza_lesao || '',
      descricao_ocorrencia: data.descricao_ocorrencia || '',
      numero_cat: data.colaboradores_acidentados?.[0]?.numero_cat || data.numero_cat || '',
      cid: data.colaboradores_acidentados?.[0]?.cid || data.cid || '',
      ...
      arquivo_cat: data.colaboradores_acidentados?.[0]?.arquivo_cat || data.arquivo_cat || '',
