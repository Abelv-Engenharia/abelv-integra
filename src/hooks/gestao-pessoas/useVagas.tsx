...
function converterVagaDB(vaga: VagaDB): Vaga {
  return {
    ...
    formacaoMinima: vaga.formacao_minima,
    experienciaDesejada: vaga.experiencia_desejada,
    ...
    prazoMobilizacao: new Date(vaga.prazo_mobilizacao),
    etapaAtual: vaga.etapa_atual as EtapaProcesso | undefined,
    observacoes: vaga.observacoes || undefined,
    dataCriacao: new Date(vaga.created_at),
    dataAtualizacao: new Date(vaga.updated_at),
