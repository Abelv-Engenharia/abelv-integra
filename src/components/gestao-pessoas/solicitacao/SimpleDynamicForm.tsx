...
export function SimpleDynamicForm({
    ...
    if (tipoServico === TipoServico.HOSPEDAGEM) {
      ...
      if (!formData.viajantes || formData.viajantes.length === 0) {
        ...
        formData.viajantes.forEach((viajante: ViajanteDados, index: number) => {
          if (!viajante.nome || !viajante.cpf || !viajante.rg || !viajante.telefone || !viajante.email) {
  ...
  const renderSpecificFields = () => {
    ...
    if (tipoServico === TipoServico.VOUCHER_UBER && !selectedTransportSubcategory) {
      return <TransportSubcategorySelector onSelect={setSelectedTransportSubcategory} selectedSubcategory={selectedTransportSubcategory} />;
    }
    switch (tipoServico) {
          ...
          return <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="localPartida" value={formData.localPartida || ''} onChange={e => updateFormData('localPartida', e.target.value)} className={errors.localPartida ? "border-destructive" : ""} placeholder="Endereço ou local de origem" />
                ...
                <div className="space-y-2">
                  ...
                  <Input id="localDestino" value={formData.localDestino || ''} onChange={e => updateFormData('localDestino', e.target.value)} className={errors.localDestino ? "border-destructive" : ""} placeholder="Endereço ou local de destino" />
              ...
              <div className="space-y-2">
                ...
                <Textarea id="motivo" value={formData.motivo || ''} onChange={e => updateFormData('motivo', e.target.value)} className={errors.motivo ? "border-destructive" : ""} placeholder="Justificativa para o voucher" rows={3} />
          ...
          return <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="nomeCondutor" value={formData.nomeCondutor || ''} onChange={e => updateFormData('nomeCondutor', e.target.value)} className={errors.nomeCondutor ? "border-destructive" : ""} placeholder="Nome completo do condutor" />
              ...
              <div className="space-y-2">
                ...
                <Textarea id="motivo" value={formData.motivo || ''} onChange={e => updateFormData('motivo', e.target.value)} className={errors.motivo ? "border-destructive" : ""} placeholder="Justificativa para a locação" rows={3} />
                {errors.motivo && <p className="text-sm text-destructive">{errors.motivo}</p>}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0">
                      <Calendar mode="single" selected={formData.dataRetirada} onSelect={date => updateFormData('dataRetirada', date)} initialFocus />
                    </PopoverContent>
                  </Popover>
              ...
              {formData.periodoLocacao === 'mensal' && <div className="space-y-2">
                  <Label htmlFor="franquiaKm">Franquia de KM</Label>
                  <Input id="franquiaKm" type="number" value={formData.franquiaKm || ''} onChange={e => updateFormData('franquiaKm', parseInt(e.target.value))} placeholder="Quilometragem incluída" />
                </div>}
          ...
          return <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="nomeSolicitante" value={formData.nomeSolicitante || ''} onChange={e => updateFormData('nomeSolicitante', e.target.value)} className={errors.nomeSolicitante ? "border-destructive" : ""} placeholder="Nome completo" />
              ...
              <div className="space-y-2">
                ...
                <Textarea id="motivo" value={formData.motivo || ''} onChange={e => updateFormData('motivo', e.target.value)} className={errors.motivo ? "border-destructive" : ""} placeholder="Justificativa da solicitação" rows={3} />
                {errors.motivo && <p className="text-sm text-destructive">{errors.motivo}</p>}
              </div>
              ...
              <div className="space-y-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button variant="outline" className={cn("justify-start text-left font-normal w-full", !formData.data && "text-muted-foreground", errors.data && "border-destructive")}>
                      <CalendarIcon className="mr-2 h-4 w-4" />
                      {formData.data ? format(formData.data, "dd/MM/yyyy") : "Selecione uma data"}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0">
                    <Calendar mode="single" selected={formData.data} onSelect={date => updateFormData('data', date)} initialFocus />
                  </PopoverContent>
                </Popover>
                {errors.data && <p className="text-sm text-destructive">{errors.data}</p>}
              </div>

              {formData.tipoSolicitacao === 'recarga_adicional' && <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="valorAdicional">Valor Adicional</Label>
                    <Input id="valorAdicional" type="number" step="0.01" value={formData.valorAdicional || ''} onChange={e => updateFormData('valorAdicional', parseFloat(e.target.value))} placeholder="0,00" />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="kmVeiculo">KM do Veículo</Label>
                    <Input id="kmVeiculo" type="number" value={formData.kmVeiculo || ''} onChange={e => updateFormData('kmVeiculo', parseInt(e.target.value))} placeholder="Quilometragem atual" />
                  </div>
                </div>}

              {(formData.tipoSolicitacao === 'recarga_adicional' || formData.tipoSolicitacao === 'bloqueio') && <div className="space-y-2">
                  <Label htmlFor="placaAssociada">Placa Associada</Label>
                  <Input id="placaAssociada" value={formData.placaAssociada || ''} onChange={e => updateFormData('placaAssociada', e.target.value.toUpperCase())} placeholder="ABC-1234" maxLength={8} />
                </div>}
            </>;
        }
        break;
      case TipoServico.VELOE_GO:
        return <div className="space-y-4">
            <div>
              ...
              <Input type="number" step="0.01" placeholder="0.00" value={formData.valor || ""} onChange={e => updateFormData("valor", parseFloat(e.target.value) || 0)} className={errors.valor ? "border-destructive" : ""} />
            ...
            <div>
              ...
              <Input placeholder="Digite o local de partida" value={formData.localPartida || ""} onChange={e => updateFormData("localPartida", e.target.value)} className={errors.localPartida ? "border-destructive" : ""} />
            ...
            <div>
              ...
              <Input placeholder="Digite o local de destino" value={formData.localDestino || ""} onChange={e => updateFormData("localDestino", e.target.value)} className={errors.localDestino ? "border-destructive" : ""} />
      ...
      case TipoServico.LOCACAO_VEICULO:
        return <div className="space-y-4">
            ...
            <div>
              ...
              <Input placeholder="Nome completo do condutor" value={formData.condutor || ""} onChange={e => updateFormData("condutor", e.target.value)} className={errors.condutor ? "border-destructive" : ""} />
              {errors.condutor && <p className="text-sm text-destructive mt-1">{errors.condutor}</p>}
            </div>

            <div className="flex items-center space-x-2">
              <Checkbox id="termo" checked={formData.termoResponsabilidade || false} onCheckedChange={checked => updateFormData("termoResponsabilidade", checked)} />
      ...
      case TipoServico.PASSAGENS:
        return <div className="space-y-4">
            ...
            <div>
              ...
              <Input placeholder="Descreva o motivo da viagem" value={formData.motivo || ""} onChange={e => updateFormData("motivo", e.target.value)} className={errors.motivo ? "border-destructive" : ""} />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input placeholder="Cidade de origem" value={formData.origem || ""} onChange={e => updateFormData("origem", e.target.value)} className={errors.origem ? "border-destructive" : ""} />
                {errors.origem && <p className="text-sm text-destructive mt-1">{errors.origem}</p>}
              </div>

              <div>
                <Label className="text-destructive">Destino *</Label>
                <Input placeholder="Cidade de destino" value={formData.destino || ""} onChange={e => updateFormData("destino", e.target.value)} className={errors.destino ? "border-destructive" : ""} />
            ...
            <div>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className={cn("w-full justify-start text-left font-normal", !formData.dataViagem && "text-muted-foreground")}>
                    <CalendarIcon className="mr-2 h-4 w-4" />
                    {formData.dataViagem ? format(formData.dataViagem, "dd/MM/yyyy") : "Selecione a data"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar mode="single" selected={formData.dataViagem} onSelect={date => updateFormData("dataViagem", date)} initialFocus className="p-3 pointer-events-auto" />
                </PopoverContent>
              </Popover>
            </div>
            ...
            <div className="space-y-4">
              ...
              {formData.viajantes?.map((viajante: ViajanteDados, index: number) => <Card key={index} className="p-4">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="font-medium">Viajante {index + 1}</h4>
                    {index > 0 && <Button type="button" variant="destructive" size="sm" onClick={() => {
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input placeholder="Nome completo" value={viajante.nome} onChange={e => {
                    const novosViajantes = [...formData.viajantes];
                    ...
                    <div>
                      ...
                      <Input placeholder="000.000.000-00" value={viajante.cpf} onChange={e => {
                    const novosViajantes = [...formData.viajantes];
                    ...
                    <div>
                      ...
                      <Input placeholder="00.000.000-0" value={viajante.rg} onChange={e => {
                    const novosViajantes = [...formData.viajantes];
                    ...
                    <div>
                      ...
                      <Input placeholder="(11) 99999-9999" value={viajante.telefone} onChange={e => {
                    const novosViajantes = [...formData.viajantes];
                    ...
                    <div className="col-span-2">
                      ...
                      <Input type="email" placeholder="email@exemplo.com" value={viajante.email} onChange={e => {
                    const novosViajantes = [...formData.viajantes];
            ...
            <div className="flex items-center space-x-2">
              <Checkbox id="bagagem" checked={formData.precisaBagagem || false} onCheckedChange={checked => updateFormData("precisaBagagem", checked)} />
      ...
      case TipoServico.HOSPEDAGEM:
        return <div className="space-y-4">
            ...
            <div>
              ...
              <Input placeholder="Nome do hotel ou local de hospedagem" value={formData.hotel || ""} onChange={e => updateFormData("hotel", e.target.value)} />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button variant="outline" className={cn("w-full justify-start text-left font-normal", !formData.dataInicio && "text-muted-foreground")}>
                      <CalendarIcon className="mr-2 h-4 w-4" />
                      {formData.dataInicio ? format(formData.dataInicio, "dd/MM/yyyy") : "Selecione a data"}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar mode="single" selected={formData.dataInicio} onSelect={date => updateFormData("dataInicio", date)} initialFocus className="p-3 pointer-events-auto" />
                  </PopoverContent>
                </Popover>
              </div>
              ...
              <div>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button variant="outline" className={cn("w-full justify-start text-left font-normal", !formData.dataFim && "text-muted-foreground")}>
                      <CalendarIcon className="mr-2 h-4 w-4" />
                      {formData.dataFim ? format(formData.dataFim, "dd/MM/yyyy") : "Selecione a data"}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar mode="single" selected={formData.dataFim} onSelect={date => updateFormData("dataFim", date)} initialFocus className="p-3 pointer-events-auto" />
                  </PopoverContent>
                </Popover>
              </div>
            </div>
            ...
            <div>
              ...
              <Input placeholder="Descreva o motivo da hospedagem" value={formData.motivo || ""} onChange={e => updateFormData("motivo", e.target.value)} />
            </div>
          </div>;
      case TipoServico.LOGISTICA:
        return <div className="space-y-4">
            <div>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className={cn("w-full justify-start text-left font-normal", !formData.dataServico && "text-muted-foreground")}>
                    <CalendarIcon className="mr-2 h-4 w-4" />
                    {formData.dataServico ? format(formData.dataServico, "dd/MM/yyyy") : "Selecione a data"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar mode="single" selected={formData.dataServico} onSelect={date => updateFormData("dataServico", date)} initialFocus className="p-3 pointer-events-auto" />
                </PopoverContent>
              </Popover>
            </div>
            ...
            <div>
              ...
              <Input placeholder="Descreva o motivo do serviço" value={formData.motivo || ""} onChange={e => updateFormData("motivo", e.target.value)} />
            </div>
            ...
            <div>
              ...
              <Input type="number" step="0.1" placeholder="0.0" value={formData.pesoAproximado || ""} onChange={e => updateFormData("pesoAproximado", parseFloat(e.target.value) || 0)} />
            </div>

            <div>
              <Label className="text-destructive">Remetente/Destinatário *</Label>
              <Input placeholder="Nome completo" value={formData.remetenteDestinatario || ""} onChange={e => updateFormData("remetenteDestinatario", e.target.value)} />
            </div>

            <div>
              <Label className="text-destructive">Endereço Completo *</Label>
              <Textarea placeholder="Rua, número, bairro" value={formData.enderecoCompleto || ""} onChange={e => updateFormData("enderecoCompleto", e.target.value)} />
            </div>

            <div className="grid grid-cols-3 gap-4">
              <div>
                <Label className="text-destructive">CEP *</Label>
                <Input placeholder="00000-000" value={formData.cep || ""} onChange={e => updateFormData("cep", e.target.value)} />
              </div>
              <div>
                <Label className="text-destructive">Cidade *</Label>
                <Input placeholder="Cidade" value={formData.cidade || ""} onChange={e => updateFormData("cidade", e.target.value)} />
              </div>
              <div>
      ...
      <CardContent>
        <div className="space-y-6">
          ...
          <div>
            ...
            <Textarea placeholder="Digite observações adicionais (opcional)" className="min-h-[100px]" value={formData.observacoes || ""} onChange={e => updateFormData("observacoes", e.target.value)} />
          </div>

          <div className="flex justify-end space-x-4">
            {tipoServico === TipoServico.VOUCHER_UBER && selectedTransportSubcategory && <Button type="button" variant="outline" onClick={() => setSelectedTransportSubcategory(undefined)}>
