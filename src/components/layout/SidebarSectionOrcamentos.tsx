...
import { Calculator, FolderOpen, DollarSign, BarChart3, CheckCircle, History } from "lucide-react";
import {
  SidebarGroup,
  SidebarGroupLabel,
  SidebarGroupContent,
...
export default function SidebarSectionOrcamentos({ openMenu, toggleMenu }: Props) {
  ...
  return (
    <SidebarGroup>
      <SidebarGroupLabel className="text-white">Orçamentos</SidebarGroupLabel>
      <SidebarGroupContent>
        <SidebarMenu>
          <SidebarMenuItem>
            <Collapsible open={openMenu === "orcamentos"}>
