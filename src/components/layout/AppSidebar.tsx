...
export function AppSidebar() {
  ...
  const [openMenu, setOpenMenu] = useState<string | null>(() => {
    if (currentPath.startsWith("/hora-seguranca") || 
        ...
        currentPath.startsWith("/ocorrencias")) return "gestao-sms";
  ...
  return (
    <Sidebar>
      <SidebarContent>
        ...
        {/* Render Gestão de SMS se tiver acesso a pelo menos 1 menu SMS */}
