...
const AcaoCorretivaForm = ({
  ...
  return <Card>
      ...
      <CardContent className="space-y-6">
        <FormField control={control} name="tratativaAplicada" render={({
        field
      }) => <FormItem>
              <FormLabel>Tratativa Aplicada*</FormLabel>
              <FormControl>
                <Textarea placeholder="Descreva detalhadamente a tratativa aplicada para correção do desvio" className="min-h-[100px]" {...field} onChange={e => field.onChange(e.target.value.toUpperCase())} />
              </FormControl>
              <FormMessage />
            </FormItem>} />

        <FormField control={control} name="responsavelAcao" render={({
        field
      }) => <FormItem>
              <FormLabel>Responsável pela Ação*</FormLabel>
              <FormControl>
                <Input placeholder="Nome do responsável pela ação corretiva" {...field} onChange={e => field.onChange(e.target.value.toUpperCase())} />
              </FormControl>
              <FormMessage />
            </FormItem>} />

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <FormField control={control} name="prazoCorrecao" render={({
          field
        }) => <FormItem>
          ...
          <FormField control={control} name="situacao" render={({
          field
        }) => <FormItem>
        ...
        {situacaoAcao && <div className="bg-blue-50 p-4 rounded-lg">
        ...
        <div className="bg-blue-50 p-4 rounded-lg">
          <FormField control={control} name="aplicacaoMedidaDisciplinar" render={({
          field
                ...
                <div className="space-y-1 leading-none">
                  ...
                  <p className="text-xs text-muted-foreground">Marque esta opção se será aplicada alguma medida disciplinar ao colaborador.</p>
                </div>
              </FormItem>} />
        </div>
      </CardContent>
