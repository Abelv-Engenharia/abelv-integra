...
const InspecoesCadastro = () => {
  ...
  const onSubmit = (data: z.infer<typeof formSchema>) => {
    console.log("Dados da inspeção programada:", data);
    
    // Adiciona status padrão "A REALIZAR"
    const inspecaoData = {
      ...data,
      status: "A REALIZAR",
    };
    
    console.log("Dados completos da inspeção:", inspecaoData);
    ...
    toast({
      title: "Sucesso!",
      description: "Inspeção programada cadastrada com sucesso!",
    });
        ...
        <Card className="max-w-3xl mx-auto">
          <CardContent className="pt-6 flex flex-col items-center justify-center space-y-6">
            <div className="flex flex-col items-center space-y-3">
              ...
              <h2 className="text-2xl font-bold">Inspeção programada cadastrada com sucesso!</h2>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 w-full">
              <Button className="flex-1" onClick={() => {
                ...
                Registrar nova inspeção programada
              </Button>
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex flex-col space-y-6">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Cadastro de Inspeções Programadas</h2>
          <p className="text-muted-foreground">
            Preencha os campos abaixo para cadastrar uma nova inspeção programada
          </p>
        </div>
...
export default InspecoesCadastro;
