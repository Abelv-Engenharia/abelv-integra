          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <Button variant="outline" size="sm" onClick={() => navigate("/comercial")} className="gap-2">
                  <FileText className="h-4 w-4" />
                  Detalhes da Consolidação
                </Button>
                <Link to="/comercial/cadastro">
                  ...
                  return <TableRow key={item.id} className={`hover:bg-muted/50 ${needsConsolidation ? 'bg-yellow-50 dark:bg-yellow-950/20' : ''}`}>
                        ...
                        <TableCell>
                          <div className="flex gap-1">
                            {item.status === 'Contemplado' && <Link to={`/comercial/consolidacao/${item.id}`}>
                            ...
                            <Link to={`/comercial/editar/${item.id}`}>
