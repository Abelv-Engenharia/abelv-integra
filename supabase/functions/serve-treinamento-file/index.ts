...
console.log('Edge function serve-treinamento-file iniciada')
...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Tentando servir arquivo de treinamento:', fileName)
    ...
    console.log('Tentando baixar arquivo do bucket treinamentos-anexos:', fileName)
    ...
    console.error('Erro ao servir arquivo de treinamento:', error)
    return new Response(
