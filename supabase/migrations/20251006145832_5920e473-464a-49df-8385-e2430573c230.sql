-- Corrigir função get_user_permissions para retornar permissões antigas sem conversão
...
BEGIN
  ...
  -- 2. Se não encontrou no sistema novo, buscar do sistema ANTIGO (SEM CONVERSÃO)
